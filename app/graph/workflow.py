...
from app.graph.nodes import gap_analysis_node, improvement_node, parse_resume_node
...
def build_resume_analysis_graph():
    ...
    graph_builder.add_node("improvement", improvement_node)

    graph_builder.add_edge(START, "parse_resume")
    graph_builder.add_edge("parse_resume", "gap_analysis")
    graph_builder.add_edge("gap_analysis", "improvement")
    graph_builder.add_edge("improvement", END)
